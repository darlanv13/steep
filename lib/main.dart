...
void main() async {
  ...
  try {
    ...
    print("Firebase initialization failed. Please run 'flutterfire configure'. Error: $e");
  }

  runApp(
    MultiProvider(
      providers: [
        Provider<DataService>(create: (_) => MockDataService()), // To use firebase, swap to FirebaseDataService()
