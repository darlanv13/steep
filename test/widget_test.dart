...
void main() {
  testWidgets('App dummy test to pass firebase initialization', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(const MaterialApp(home: Scaffold(body: Text('Test passed'))));
